...
const send = async () => {	
	...
	const messageParts = [
		...
		'To: Kyle Crouse <kyle.crouse@gmail.com>',
		'Content-Type: text/html; charset=utf-8',
		'MIME-Version: 1.0',
		`Subject: ${utf8Subject}`,
		'',
		`<p><b>Welcome to Output Racing League!</b> Please accept your league invitation to join upcoming sessions, and join our <a href="https://discord.gg/${`inviteCode`}">Discord server</a> to complete your registration, get league information and chat with fellow drivers.</p>`,
...
fs.readFile(path.join(__dirname, '../oauth-tokens.json'))
